...
SM2KeyPair.prototype.priToString = function(mode) {
    return this.pri.toString(16, 32);
}
...
SM2KeyPair.prototype.getpub= function() {
    var s;
    if (this.pub) {
        s = '04'+ this.pub.getX().toString(16) + this.pub.getY().toString(16) ;
    } else {
        s = "null";
    }
    return s;
